...
<el-container v-if="!permission.table.${layout.options.boSubEntity}.hidden">
  <el-header style="height:30px;line-height:30px;background: #fafafa; font-weight: bold;font-size: 14px;" class="printHide">
  ...
  <el-main>
      ...
      <div class="grandson_table_wrap" v-tableDrag>
        <table class="form-table" cellspacing="0" cellpadding="0" border="0">
          ...
          <tbody>
              <tr v-for="(item, sunIndex) in data.${sunTablePath}" :key="item.sub_guid || sunIndex" :data-index="sunIndex" :class="{'transition':sunIndex==transitionIndex}" :data-subname="'data.${subName}'">
