...
//主表名
var mainTableName = "d_no_lawsuit_approve";
...
setSerialNO("nliti_appr_serial_no","serial_no");
//公文编号插入到右上角
insertSearialNo(20);
//合并单元格，行数下标从0开始，别忘记减一！！！
mergeCell(18, 3, "呈报部门意见");
//设置经办人宽度
//setFieldCellWidth(215, "perf_users");
//设置公文宽度
//setFieldCellWidth(550, "title");
//设置是否营业部公文
//setFieldCellWidth(550, "is_sales_bumph");
///设置是否经发管委
//setFieldCellWidth(550, "is_eco_approve");
//启动流程时，按钮文字改为 ‘提交’
