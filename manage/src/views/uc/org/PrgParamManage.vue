<template>
  <div class="fullheight">
    <ht-table
      ...
      :show-export="false"
      :default-querys="[{property:'TYPE_',value: '2'}]"
    ...
    >
      ...
      <template>
        ...
        <ht-table-column prop="ctlType" label="控件类型" width="180">
          <template v-slot="{row}">
    ...
    <el-dialog
      ...
      :append-to-body="true"
    >
      <el-form v-model="ProParam" data-vv-scope="editParamForm">
  ...
  methods: {
    ...
    afterLoadData(data) {
      ...
      if (this.dialogVisible) {
        ...
        this.ProParam = data;
        this.ctlTypeChecked();
        setTimeout(() => this.$validator.validateAll("editParamForm"));
      }
    },
