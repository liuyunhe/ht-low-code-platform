<template>
  <div class="inputs">
    ...
    <!-- 自定义视图对话框-->
    <eip-custom-view-dialog
      ref="eipCustomViewDialog"
      name="eipCustomViewDialog"
...
<script>
  ...
  import eipCustomViewDialog from "@/components/dialog/EipCustomViewDialog.vue";
  export default {
    name: "eip-custom-view-selector",
    props: {
    ...
    methods: {
      showDialog() {
        ...
        this.$refs.eipCustomViewDialog.showDialog(this.selectors);
      },
      handleClose(done) {
        this.$refs.eipCustomViewDialog.handleClose();
        done && done();
      },
